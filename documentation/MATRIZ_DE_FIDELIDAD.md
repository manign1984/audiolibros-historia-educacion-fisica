...
- **Documentación:** análisis nuevo que describe el estado recuperado.

| Componente | Clasificación | Evidencia | Observación |
|---|---|---|---|
| `portable-site/src/App.jsx` | Literal | Igual al commit `7882327…`; SHA-256 `e18fdcb273de5f61cdedcfd74ed3e89f25a8ae39edbf431b3f912e1e08838f13` | Estructura, navegación, carrusel, actividades y créditos |
...
| `portable-site/src/data.js` | Literal | SHA-256 `e74f7d64229ecaa562e0c78821bde5b99afa75ab56fd497312191b1828caf538` | Línea de tiempo, estrategias, jugadores y actividades |
...
| `data/content-structure_exact.json` | Extracción literal | Generado desde `data.js` y `readingDocument.js` | Estructura sin reinterpretación editorial |
...
Se compararon recursivamente `src/` y `public/assets/` entre la copia fresca del origen y la versión portable. También se compararon por separado `index.html` y el generador de lectura. No se encontraron diferencias.
...
La fuente de verdad para reproducir el comportamiento es `readingDocument.js`; la extracción JSON es su representación portátil sin pérdida.
